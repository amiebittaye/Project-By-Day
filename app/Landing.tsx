  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-background to-background/95">
      ...
      <div className="container pt-32 pb-20">
        {/* Content */}
        <div className="max-w-200 mx-auto text-center space-y-8 mb-20">
          ...
          <div className="grid sm:grid-cols-2 gap-4 pt-4 max-w-150 mx-auto">
        ...
        <div className="relative w-full max-w-300 mx-auto mt-20">
          <div className="relative">
            <div className="relative bg-background/95 backdrop-blur rounded-lg shadow-2xl">
              <Image
                src={
                  resolvedTheme === 'dark'
                    ? '/project-by-day-dark.png'
                    : '/project-by-day-light.png'
                }
                alt="App preview"
                width={1824}
                height={1080}
                ...
                priority
              />
              <div className="absolute inset-x-0 bottom-0 h-40 bg-linear-to-b from-transparent to-background"></div>
            </div>
          </div>
        </div>
      </div>
