...
/**
 * TaskActivity represents the structured activity content used when creating activity log entries.
 * It is an array mixing strings and structured objects for user/status/date references.
 */
type TaskActivity = Array<
  | { type: 'user' | 'status' | 'date'; id?: string; value?: string }
  | string
>;
