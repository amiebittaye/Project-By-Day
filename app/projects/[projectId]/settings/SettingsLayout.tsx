    ...
    <div className="grid h-minus-80 w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      <div className="hidden border-r 0 md:block">
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex h-14 items-center border-b px-4 lg:h-15 lg:px-6 dark:bg-gray-950">
            <Link
      ...
      <div className="flex flex-col">
        <header className="flex h-14 items-center gap-4 border-b px-4 lg:h-15 lg:px-6 dark:bg-gray-950">
          <Sheet>
